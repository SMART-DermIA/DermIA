...
import AddToAlbum from "../../addToAlbum/addToAlbum"; // Importa el componente AddToAlbum
...
export default function ImageUpload() {
    ...
    const [showAlbum, setShowAlbum] = useState(false); // Nuevo estado para mostrar el álbum
    ...
    const handleAddToAlbum = () => {
        setShowAlbum(true); // Cambia el estado para mostrar el contenido del álbum
    };

    return (
        <div className="upload-container">
            {showAlbum ? (
                <AddToAlbum /> // Muestra el componente AddToAlbum si showAlbum es true
            ) : (
                <>
                    {upload || preview ? (
                        <div>
                        ...
                        <div className="result-box">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm mb-3 button-group">
                                    ...
                                    <button className="confirm-button" onClick={handleAddToAlbum}>
